...
module.exports = function getAppInfo(api, pkg, vc) {
  ...
  .then(function (d) {
    ...
    var basicInfo = {
      ...
      size: Long.fromValue(d.details.appDetails.installationSize).toNumber(),
      uploadDate: d.details.appDetails.uploadDate,
      vendor: d.creator,
      versionCode: d.details.appDetails.versionCode,
      versionString: d.details.appDetails.versionString,
